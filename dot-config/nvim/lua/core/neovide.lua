...
vim.opt.belloff:append("all")             -- Disable all bells
vim.g.neovide_remember_window_size = true -- Remember window size between sessions
vim.g.neovide_ime_enabled = false         -- Disable IME (input method editor)
...
vim.keymap.set("",           ctrl_key .. "v>", "+p<CR>",          { noremap = true, silent = true })
vim.keymap.set("!",          ctrl_key .. "v>", "<C-R>+",          { noremap = true, silent = true })
vim.keymap.set("t",          ctrl_key .. "v>", '<C-\\><C-n>"+Pi', { noremap = true, silent = true })
